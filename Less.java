...
public class Less {
    ...
    public static void main(String[] args) {
        // запуск задания
        // System.out.printf("Длинна масива: %d\n", task1(new int[]{2, 3, 3}));
        // task2();
        // task3();
        task4();
    }
     ...
     * Если длинна массива меньше некоторого заданного минимума, метод возвращает
     * -1, в качестве кода ошибки, иначе длинну массива
     */
    ...
    static void task2() {
        while (true) {
            ...
            if (scanner.hasNextInt()) {
                ...
                if (codeResult == -1) {
                    System.out.println("Длинна массива менее трех элементов");
                } else if (codeResult == -2) {
                    System.out.println("Элемент не найден");
                } else if (codeResult == -3) {
                    System.out.println("Массив некорректно проинициализировался");
                } else {
    ...
    static int processArray(int[] arr, int searchNumber) {
        ...
        if (arr.length < 3) {
            return -1; // Длинна массива меньше у3
        }
        int searchRes = -2;
